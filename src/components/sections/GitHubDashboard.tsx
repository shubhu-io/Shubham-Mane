    ...
    return (
      <section id="github" className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="card-glow p-8 max-w-lg mx-auto">
            <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-gray-100 dark:bg-[#21262d] flex items-center justify-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">GitHub data temporarily unavailable</p>
            <p className="text-gray-400 dark:text-gray-500 text-xs">Please check back later or visit my GitHub directly</p>
            <a
              href={`https://github.com/${username}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700 transition-colors"
            >
